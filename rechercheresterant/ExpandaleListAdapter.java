...
public class ExpandaleListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String,List<Global>> listHashMap;




    public ExpandaleListAdapter(Context context, List<String> list, HashMap<String, List<Global>> listHashMap) {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        Global g=(Global)getChild(groupPosition,childPosition);
        LayoutInflater infalInflater = (LayoutInflater) this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        convertView = infalInflater.inflate(R.layout.listdemande, null);
        TextView textView = (TextView) convertView.findViewById(R.id.childD);
